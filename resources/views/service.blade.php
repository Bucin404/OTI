        ...
        <div class="container">
            ...
            <div class="row pt-45">
                <div class="col-lg-4 col-sm-6">
                    <div class="service-card">
                        <a href="/service-details">
                            <img src="{{ asset('assets/img/service-icon/1.png') }}" alt="Images">
                        </a>
                        <a href="/service-details">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="service-card">
                        <a href="/service-details">
                            <img src="{{ asset('assets/img/service-icon/2.png') }}" alt="Images">
                        </a>
                        <a href="/service-details">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="service-card">
                        <a href="/service-details">
                            <img src="{{ asset('assets/img/service-icon/3.png') }}" alt="Images">
                        </a>
                        <a href="/service-details">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="service-card">
                        <a href="/service-details">
                            <img src="{{ asset('assets/img/service-icon/4.png') }}" alt="Images">
                        </a>
                        <a href="/service-details">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="service-card">
                        <a href="/service-details">
                            <img src="{{ asset('assets/img/service-icon/5.png') }}" alt="Images">
                        </a>
                        <a href="/service-details">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="service-card">
                        <a href="/service-details">
                            <img src="{{ asset('assets/img/service-icon/6.png') }}" alt="Images">
                        </a>
                        <a href="/service-details">
